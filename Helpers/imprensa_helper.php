...
function editarPublicacao($id, $imagem, $titulo, $texto, $quando, $posicao){
    iduSQL("UPDATE imprensa SET imagem='$imagem', titulo='$titulo', texto='$texto', quando='$quando', posicao='$posicao' WHERE id='$id'");
}
