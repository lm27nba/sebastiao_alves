                        ...
                        <div class="collapse navbar-collapse d-block-md px-0" id="navbarNavDropdown">
                            <ul class="navbar-nav text-uppercase M1 mx-auto gap-md-2">
                                ...
                                <li class="nav-item me-md-2 dropdown">
                                    <a class="nav-link dropdown" href="livros.html" role="button" 
                                    data-bs-toggle="dropdown" aria-expanded="false">
                                        Livros
                                    </a>
                                    <ul class="dropdown-menu SM1">
                                        <li><a class="dropdown-item" href="livros.html">Senhora do Amor e da Guerra</a></li>
                                        <li><a class="dropdown-item" href="livros.html">O Caracol Estrábico</a></li>
                                        <li><a class="dropdown-item" href="livros.html">O Coleccionador de Amnésias</a></li>
                                        <li><a class="dropdown-item" href="livros.html">O Velho que Pensava que Fugia</a></li>
                                    </ul>
                                </li>
